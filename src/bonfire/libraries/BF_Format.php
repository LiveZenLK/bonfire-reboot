...
class BF_Format {
	 ...
	 * @return  Factory
	 */
	public function factory($data, $from_type = null, $callback=null)
	{
		// Stupid stuff to emulate the "new static()" stuff in this libraries PHP 5.3 equivilent
		$class = __CLASS__;
		return new $class($data, $from_type, $callback);
	}
	 ...
	 */
	public function __construct($data = null, $from_type = null, $callback=null)
	{
	...
	// Encode as JSON
	public function to_extjson()
	{
		$data = array();

		$data['count'] = @count( $this->_data );
	...
	public function to_jsonp(){
		return $this->_callback . '(' . json_encode($this->_data) . ')';
	}
